  ...
  floors: [
    {
      ...
      level: 1,
      rooms: [
        { id: "lobby", label: "Lobby", type: "lobby", x: 2, y: 2, width: 30, height: 28 },
        { id: "reception", label: "Reception", type: "reception", x: 33, y: 2, width: 18, height: 14 },
        { id: "concierge", label: "Concierge", type: "reception", x: 33, y: 17, width: 18, height: 13 },
        { id: "restaurant", label: "Restaurant", type: "restaurant", x: 52, y: 2, width: 28, height: 28 },
        { id: "bar", label: "Lobby Bar", type: "restaurant", x: 81, y: 2, width: 17, height: 14 },
        { id: "boutique", label: "Boutique", type: "shop", x: 81, y: 17, width: 17, height: 13 },
        { id: "gym", label: "Fitness Center", type: "gym", x: 2, y: 31, width: 22, height: 22 },
        { id: "pool", label: "Pool Deck", type: "pool", x: 25, y: 31, width: 26, height: 22 },
        { id: "kitchen", label: "Kitchen", type: "kitchen", x: 52, y: 31, width: 18, height: 14 },
        { id: "laundry", label: "Laundry", type: "utility", x: 71, y: 31, width: 13, height: 14 },
        { id: "boiler", label: "Boiler Room", type: "utility", x: 85, y: 31, width: 13, height: 14 },
        { id: "kitchen-store", label: "Cold Store", type: "utility", x: 52, y: 46, width: 14, height: 7 },
        { id: "loading", label: "Loading Bay", type: "utility", x: 67, y: 46, width: 17, height: 7 },
        { id: "garage", label: "Valet Garage", type: "utility", x: 85, y: 46, width: 13, height: 7 },
        { id: "entrance", label: "Main Entrance", type: "lobby", x: 2, y: 54, width: 30, height: 6 },
        { id: "ballroom", label: "Ballroom", type: "lounge", x: 33, y: 54, width: 51, height: 6 },
        { id: "stairs-1", label: "Stairwell", type: "stairs", x: 85, y: 54, width: 13, height: 6 },
      ],
    },
    {
      id: "floor-2",
